	...
	<body class="color-mode">
        ...
        <div class="container">
            ...
            <?php
                ...
                if($result){
                    echo '<form enctype="multipart/form-data" method="POST" action="verif_user_pwd.php?user_id='.$result['user_id'].'" class="rounded" style="background-color: #FFFAFA; max-width: 1000px;">';
                   echo '            
                        <div class="row mb-3">
                        ...
                        <a class="btn btn-sm btn-danger" href="user_profil.php?user_id=' .$result['user_id'] . '">Retour</a>
                        </form>';
                } else {
